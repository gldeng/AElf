...
{
    public BigIntValue[] VerifyProofStep3(BigIntValue[] transcript, BigIntValue[] aux, BigIntValue[] buf)
    {
        // @formatter:off
        var mulmod = (BigIntValue a, BigIntValue b, BigIntValue m) => (a * b) % m;
        var addmod = (BigIntValue a, BigIntValue b, BigIntValue m) => (a + b) % m;
        (buf[14], buf[15]) = (transcript[40], transcript[41]);
        buf[16] = mulmod(buf[17], buf[35], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[38], transcript[39]);
        buf[16] = buf[17];
        Context.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (buf[0], buf[1]);
        buf[16] = mulmod(buf[21], mulmod(buf[30], buf[7], AggregatorLib.QMod), AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        buf[17] = mulmod(mulmod(buf[19], buf[8], AggregatorLib.QMod), buf[28], AggregatorLib.QMod);
        (buf[14], buf[15]) = (transcript[16], transcript[17]);
        buf[16] = mulmod(buf[17], buf[7], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        buf[20] = mulmod(buf[20], buf[23], AggregatorLib.QMod);
        (buf[14], buf[15]) = (transcript[18], transcript[19]);
        buf[16] = mulmod(buf[21], mulmod(buf[20], buf[7], AggregatorLib.QMod), AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[32], transcript[33]);
        buf[16] = mulmod(buf[25], buf[7], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[20], transcript[21]);
        buf[16] = buf[17];
        Context.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[22], transcript[23]);
        buf[16] = mulmod(buf[21], buf[20], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[26], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        buf[17] = mulmod(buf[24], buf[23], AggregatorLib.QMod);
        ...
        buf[16] = mulmod(buf[21], mulmod(buf[17], buf[7], AggregatorLib.QMod), AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[17], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], mulmod(buf[24], buf[7], AggregatorLib.QMod), AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[24], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[31], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[23], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        buf[17] = mulmod(buf[19], buf[19], AggregatorLib.QMod);
        (buf[14], buf[15]) = (transcript[24], transcript[25]);
        buf[16] = mulmod(buf[17], buf[23], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[25], buf[23], AggregatorLib.QMod);
        Context.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[36], transcript[37]);
        buf[16] = buf[21];
        Context.EccMulAdd(buf, 12);

        BigIntValue[] ret = new BigIntValue[4];
        ret[0] = buf[10];
        ret[1] = buf[11];
        ret[2] = buf[12];
        ret[3] = buf[13];
